...
namespace libgraphcpp
{
                          ...
                          const int res)
  {
      ...
      point_spheres(nodes, nodes_radius, nodes_colors, res, nodes_V, nodes_T, nodes_C);
      line_cylinders(edges_begin, edges_end, edges_radius, edges_colors, res, edges_V, edges_T, edges_C);
