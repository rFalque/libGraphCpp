...
class GraphVertexColorQuantity;
class GraphEdgeColorQuantity;
class GraphVertexCountQuantity;
class GraphVertexIsolatedScalarQuantity;
class GraphEdgeCountQuantity;
class GraphDistanceQuantity;
class GraphVertexScalarQuantity;
class GraphEdgeScalarQuantity;
class GraphVertexVectorQuantity;
class GraphFaceVectorQuantity;
class GraphVertexIntrinsicVectorQuantity;
class GraphFaceIntrinsicVectorQuantity;
class GraphOneFormIntrinsicVectorQuantity;


template <> // Specialize the quantity type
struct QuantityTypeHelper<Graph> {
...
class Graph : public QuantityStructure<Graph> {
public:
  ...
  Graph(std::string name, const V& vertexPositions, const F& faceIndices);
